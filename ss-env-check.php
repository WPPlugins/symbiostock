...
<?php
	...
	function error_notice_proquickguide() {
		?>
		<div class="update-nag">
			<?php print __('Check out our <a href="http://www.symbiostock.org/docs/3-minute-guide-to-launching-your-store/" target="_blank">3 minute getting started guide</a> to start using Symbiostock Pro. Click <a href="'.admin_url( 'edit.php?post_type=product&ss_ignorequickguide=1').'">here</a> to hide this notice.','ss'); ?>
		</div>
		<?php
	}
	...
	function error_notice_litequickguide() {
		?>
		<div class="update-nag">
			<?php print __('Check out our <a href="http://www.symbiostock.org/docs/symbiostock-lite-quick-guide/" target="_blank">quick guide</a> to start using Symbiostock Lite. Click <a href="'.admin_url( 'edit.php?post_type=product&ss_l_ignorequickguide=1').'">here</a> to hide this notice.','ss'); ?>
		</div>
		<?php
	}
